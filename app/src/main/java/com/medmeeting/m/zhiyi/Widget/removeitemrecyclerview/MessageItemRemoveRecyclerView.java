 ...
 */
public class MessageItemRemoveRecyclerView extends RecyclerView {
    ...
    public MessageItemRemoveRecyclerView(Context context) {
        this(context, null);
    }

    public MessageItemRemoveRecyclerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MessageItemRemoveRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mDeleteBtnState == 0) {
                    ...
                    MessageViewHolder viewHolder = (MessageViewHolder) getChildViewHolder(view);
