...
public class MyLiveProgramListModel{
    private static final String TAG = MyLiveProgramListModel.class.getSimpleName();

        public void LoadData(final OnLoadDataListListener listener, Integer roomId) {
            HttpData.getInstance().HttpDataGetLivePrograms(new Observer<HttpResult3<LiveDto, Object>>() {
                @Override
