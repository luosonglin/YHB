package com.medmeeting.m.zhiyi.UI.LiveView.live.liveshow.fakeserver;
...
public class FakeServer {
     ...
     */
    public static final String APP_KEY = "qd46yzrfq3lwf";//25wehl3u27x1w

    /**
     * 务必妥善保存, 不能放在应用端, 否则可以被反编译获得.
     */
    public static final String APP_SECRET = "xVOEBe44fhL";//ymmZMji2pzvzRR
