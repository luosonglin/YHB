...
public class LiveDetailAdapter extends BaseQuickAdapter<BannerDto.BannersBean> {
    public LiveDetailAdapter(int layoutResId, List<BannerDto.BannersBean> data) {
    ...
    protected void convert(BaseViewHolder helper, BannerDto.BannersBean item) {
        ...
        helper.setText(R.id.name, item.getTitle() + "")
                .setText(R.id.author, "主讲人：" + item.getTitle())
