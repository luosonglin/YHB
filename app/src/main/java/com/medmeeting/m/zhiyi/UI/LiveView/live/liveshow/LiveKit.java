package com.medmeeting.m.zhiyi.UI.LiveView.live.liveshow;
...
import com.medmeeting.m.zhiyi.UI.LiveView.live.liveshow.ui.message.InfoMsgView;
import com.medmeeting.m.zhiyi.UI.LiveView.live.liveshow.ui.message.TextMsgView;
...
public class LiveKit {
    ...
    private static RongIMClient.OnReceiveMessageListener onReceiveMessageListener = new RongIMClient.OnReceiveMessageListener() {
        ...
        public boolean onReceived(Message message, int i) {
            Log.e(TAG+" 接收监听者", message.getContent()
                    +"\n " + message.getExtra()
                    +"\n " + message.getUId()
...
接收监听者: io.rong.message.TextMessage@39c7ec9c
     null
     5E5Q-G2L7-CG00-1GGM
     RECEIVE
     237
...
ios
     ...
     RECEIVE
     237
     145 1496213153329 SENT

android wen ge
     E/LiveKit 接收监听者: io.rong.message.TextMessage@dab3334
     null
     5E5Q-I5JK-GG00-1GGM
     RECEIVE
     237
     211 1496213664676 SENT

     */

    private static final String TAG = LiveKit.class.getSimpleName();
    ...
    public static void sendMessage(final MessageContent msgContent) {
        ...
        RongIMClient.getInstance().sendMessage(msg, null, null, new RongIMClient.SendMessageCallback() {
            ...
            public void onSuccess(Message message) {
                Log.e(TAG, message.getContent()+" "+message.getExtra()+" "+message.getUId()+" "+message.getTargetId());
            }
