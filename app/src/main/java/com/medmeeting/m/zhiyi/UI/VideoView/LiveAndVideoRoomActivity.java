 ...
 * @org Healife
 */
public class LiveAndVideoRoomActivity extends AppCompatActivity {
    private static final String TAG = LiveAndVideoRoomActivity.class.getSimpleName();
    ...
    public void initShare(final int roomId, final String title, final String phone, final String description) {
        ...
        mShareListener = new LiveAndVideoRoomActivity.CustomShareListener(this);
        /*增加自定义按钮的分享面板*/
        mShareAction = new ShareAction(LiveAndVideoRoomActivity.this)
                ...
                .setShareboardclickCallback((snsPlatform, share_media) -> {
                    ...
                    new ShareAction(LiveAndVideoRoomActivity.this)
                            .withMedia(web)
    ...
    private static class CustomShareListener implements UMShareListener {
        ...
        private WeakReference<LiveAndVideoRoomActivity> mActivity;

        private CustomShareListener(LiveAndVideoRoomActivity activity) {
    ...
    private void initView(Integer userId) {
        ...
        mRecyclerView.addItemDecoration(new DividerItemDecoration(LiveAndVideoRoomActivity.this, DividerItemDecoration.VERTICAL));
        mRecyclerView.setLayoutManager(new LinearLayoutManager(LiveAndVideoRoomActivity.this));
        ...
        HttpData.getInstance().HttpDataGetUserRedRoom(new Observer<HttpResult3<Object, UserRedEntity>>() {
            ...
            public void onNext(HttpResult3<Object, UserRedEntity> data) {
                ...
                Glide.with(LiveAndVideoRoomActivity.this)
                        ...
                        .crossFade()
                        .transform(new GlideCircleTransform(LiveAndVideoRoomActivity.this))
                        .placeholder(R.mipmap.avator_default)
                        .into(avatarIv);

                mAdapter.addData(data.getEntity().getRoomList());
                mAdapter.setOnRecyclerViewItemClickListener((view, position) -> {
                    Intent intent = new Intent(LiveAndVideoRoomActivity.this, LiveDetailActivity.class);
